                    ...
                    <div class="card-body p-md-5">
                      <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                          ...
                          <form class="mx-1 mx-md-4" method="post" action="/registore">
                            ...
                            <div class="d-flex flex-row align-items-center mb-4">
                              ...
                              <div class="form-outline flex-fill mb-0">
                                <input type="text" id="form3Example1c" name="nama_depan_pengguna" class="form-control @error('name')is-invalid @enderror" value="{{ old('name') }}" required/>
                            ...
                            <div class="d-flex flex-row align-items-center mb-4">
                                <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <select id="form3Example1c" class="form-control @error('name')is-invalid @enderror" name="role_id">
                                ...
                                <input type="hidden" id="form3Example1c" name="slug_pengguna" value="                    
                                {{-- RANDOM CREATE SLUG --}}
                                @php
